        ...
        <Stack spacing="16px">
          <Box>
            <Text fontSize={'14px'} lineHeight="22px" maxWidth="72ch">
              This address participated in the Base token offering. Its BASE is subject to the
          ...
          <Box mt="12px" pb="32px">
            ...
            <Section p="16px" mt="32px">
              <Stack isInline alignItems="center">
                ...
                <Caption>This table only shows data from after the launch of Base 2.0</Caption>
              </Stack>
            </Section>
