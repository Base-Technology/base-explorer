    ...
    <Card padding={6}>
      ...
      >
        <Box>
          ...
          >
            {mempoolFeeAll / MICROSTACKS_IN_STACKS} BASE
          </Text>
          ...
          <VStack gap={3} alignItems="flex-start">
            ...
            >
              <Flex gap={0.5} alignItems={'center'} justifyContent={'center'} color="secondaryText">
                ...
                >
                  {`${Number((mempoolFeeTokenTransfer / MICROSTACKS_IN_STACKS).toFixed(3))}`} BASE
                </Box>
              </Flex>
            </Tooltip>
            <Tooltip
              label={`Contract call tx fee: ${mempoolFeeContractCall / MICROSTACKS_IN_STACKS} BASE`}
            >
              <Flex gap={0.5} alignItems={'center'} justifyContent={'center'} color="secondaryText">
                ...
                <Box
                  ...
                  suppressHydrationWarning
                >
                  {`${Number((mempoolFeeContractCall / MICROSTACKS_IN_STACKS).toFixed(3))}`} BASE
                </Box>
              </Flex>
            </Tooltip>
            <Tooltip
            ...
            >
              <Flex gap={0.5} alignItems={'center'} justifyContent={'center'} color="secondaryText">
                ...
                <Box
                  ...
                  suppressHydrationWarning
                >
                  {`${Number((mempoolFeeSmartContract / MICROSTACKS_IN_STACKS).toFixed(3))}`} BASE
                </Box>
              </Flex>
            </Tooltip>
          </VStack>
